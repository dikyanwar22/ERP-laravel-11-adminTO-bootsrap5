              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <input type="text" name="nama" class="form-control form-control-lg form-control-a" placeholder="Nama Lengkap" required>
                  </div>
                </div>
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <textarea name="pesan" class="form-control" name="message" cols="45" rows="8" placeholder="Pesan" required></textarea>
                  </div>
                </div>
