<header class="main-header">
  ...
  <a href="" class="logo no-underline">
    <span class="name-enterprise-laptop">ERP</span>
    <span class="name-enterprise-hp">Perumahan Keandra Palimanan</span>
  </a>
...
<li class="user-footer">
  ...
  <div class="pull-right">
    <a href="#" class="btn btn-default btn-flat" id="logout-button">Sign out</a>
