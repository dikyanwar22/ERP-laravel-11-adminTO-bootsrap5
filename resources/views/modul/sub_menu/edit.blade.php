    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow-sm rounded">
                ...
                <div class="card-body">
                    <form action="{{ route('submenu_update', $e->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    @method('PUT')
                    <div class="form-group">
                      ...
                      <select name="menu_id" class="form-control select2" required>
                        ...
                        <option value="<?= $v->id; ?>" <?= ($v->id == $e->menu_id) ? 'selected' : ''; ?> >[Menu: <?= $v->menu; ?>] - [Modul: <?= $v->modul; ?>]</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label><b>Nama Sub Menu</b></label>
                      <input type="text" name="sub_menu" value="<?= $e->nama; ?>" required class="form-control">
                    </div>
                    <div class="form-group">
