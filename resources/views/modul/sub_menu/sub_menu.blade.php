                ...
                <div class="card border-0 shadow-sm rounded">
                    ...
                    <div style="padding-bottom: 30px;">
                       <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('sub_menu') }}">Sub Menu</a>
                            </li>
                        </ul>
                    </div>

                        <a href="{{route('submenu_add')}}" class="btn btn-md btn-success mb-3">TAMBAH</a>
                        <table class="table table-bordered" id="tabel1">
                            ...
                            <tr>
                                ...
                                <td><?= $v->folder; ?> / <?= $v->class; ?> / <b style="color: red"><?= $v->function; ?></b></td>
                              ...
                              <td>
                                  <a href="{{route('submenu_edit', $id)}}" class="btn btn-sm btn-primary">Edit</a>
                              </td>
                          </tr>
                          <?php $no++; endforeach; ?>
                              <?php else : ?>
