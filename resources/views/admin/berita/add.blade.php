...
<section>
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <form action="<?= url('Admin/Berita/TambahBerita'); ?>" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="box-body">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="isi" class="textEditor" placeholder="Masukan konten disini..." cols="80" rows="15"></textarea>
            </div>
          </div>
